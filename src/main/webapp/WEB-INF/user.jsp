...
<body>
	...
	<div class="layui-collapse">
		<div class="layui-colla-item">
			<h2 class="layui-colla-title">用户信息-查詢条件</h2>
					...
					<form class="layui-form">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" id="code" placeholder="请输入用户编号"
							...
							<label class="layui-form-label"></label> <span> <input
								...
								id="addUser" value="&#xe608;添加" /> <input type="button"
								class="layui-btn layui-icon" id="selectUser" value="&#xe615;查找" />
							</span>
						</div>
					</form>
					<div class="layui-form-item">
						<label class="layui-form-label"></label>
						 <a class="layui-btn" href="${PATH}/poi/excleUser">导出Excel</a>
						 <label class="layui-form-label"></label>
						 <a class="layui-btn" href="${PATH}/poi/modelUser">生成模板</a>
						 <label class="layui-form-label"></label>
	...
	<div id="Update" style="display: none;">
		<form class="layui-form layui-form-pane" action="${PATH}/user/updata"
			method="POST" id="updateUser">

			<div class="layui-form-item">
				<label class="layui-form-label">用户编号</label>
				<div class="layui-input-inline">
					<input type="text" readonly="readonly" id="userCode"
						name="userCode" lay-verify="required" placeholder="请输入"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
	...
	<div id="Add" style="display: none;">
		<form class="layui-form layui-form-pane" action="${PATH}/user/add"
			method="POST" id="registSubmit">

			<div class="layui-form-item">
				<label class="layui-form-label">人员编号</label>
				<div class="layui-input-inline">
					<input type="text" name="userCode" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="userPass" lay-verify="required"
						placeholder="请输入" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
		...
		layui.use([ 'form', 'jquery', 'layer', "table" ], function() {
			...
			$("#selectUser").click(function() {
				...
				table.render({
					...
					page : true //开启分页
					,
					where : {userCode : code,userName : name},
					cols : [ [ 
						{type : 'checkbox',fixed : 'left'}, 
						{field : 'id',title : 'ID',sort : true}, 
						{field : 'userCode',title : '人员编号'}, 
			...
			table.on('tool(test)', function(obj) {
				...
				if (obj.event === 'del') {
					layer.confirm('真的删除行么', function(index) {
						...
						layer.close(index);
						$.ajax({
							url : "${PATH}/user/deleteUser?userCode="
									+ data.userCode,
							type : "GET",
					...
					$.ajax({
						url : "${PATH}/user/selectByCode?userCode="
								+ data.userCode,
						type : "GET",
						success : function(result) {
